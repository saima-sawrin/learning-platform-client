...
import PDFFile from '../../PDFFile/PDFFile';
 ...
 {({loading}) => (loading ? <Button>Loading Document...</Button> : <Button  >Download PDF</Button> )}
        ...
        <ButtonGroup vertical className='d-inline mb-2 my-3 '>
          <Button  variant="primary"><Link className='text-decoration-none text-white d-inline m ' to='/checkout'>{buy}</Link></Button>
